...
import br.com.hugo.converter.custom.PersonConverter;
...
public class PersonService {
	...
	public PersonVO update(PersonVO person) {
		var entity = personRepository.findById(person.getId()).orElseThrow(() -> new ResourceNotFoundException("Nenhum registro encontrado para esse id"));
